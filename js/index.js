$(function() {
    ...
    //アルファベット画像
    let alphabetEImg = new Image();
    alphabetEImg.src = "./img/e.png";
    let alphabetFImg = new Image();
    alphabetFImg.src = "./img/f.png";
    ...
    lines.push({'start': [gridLeft + cellSize * 2, gridTop + cellSize * 5], 'end': [gridLeft + cellSize * 4, gridTop + cellSize * 5]});
    lines.push({'start': [gridLeft + cellSize * 11, gridTop + cellSize], 'end': [gridLeft + cellSize * 11, gridTop + cellSize * 3]});
    ...
    let drawShapes = function() {
        ...
        //E,Fを描画
        let E1Position = [gridLeft + cellSize * 1.15, gridTop + cellSize * 5.15];
        ctx.drawImage(alphabetEImg, E1Position[0], E1Position[1], cellSize * 0.7, cellSize * 0.7);
        let F1Position = [gridLeft + cellSize * 4.15, gridTop + cellSize * 5.15];
        ctx.drawImage(alphabetFImg, F1Position[0], F1Position[1], cellSize * 0.7, cellSize * 0.7);

        let E2Position = [gridLeft + cellSize * 11.15, gridTop + cellSize * 0.15];
        ctx.drawImage(alphabetEImg, E2Position[0], E2Position[1], cellSize * 0.7, cellSize * 0.7);
        let F2Position = [gridLeft + cellSize * 11.15, gridTop + cellSize * 3.15];
        ctx.drawImage(alphabetFImg, F2Position[0], F2Position[1], cellSize * 0.7, cellSize * 0.7);
