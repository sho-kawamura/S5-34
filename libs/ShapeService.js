const ShapeService = function() {
    ...
    this.gridTopRate = 0.185;    // canvas高さ何割分をグリッド上の高さにするか
    this.gridLeftRate = 0.08;   // canvas高さ何割分をグリッド横の幅にするか
    this.cellSizeRate = 0.0875;   // canvas高さ何割分をセル1個分の大きさにするか
    this.cellsWidth = 12;       // セルの個数（横）
    this.cellsHeight = 6;      // セルの個数（縦）
